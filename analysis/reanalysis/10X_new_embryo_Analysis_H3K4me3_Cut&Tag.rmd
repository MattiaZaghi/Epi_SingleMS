...
ggarrange(plot.list_elbow[[1]],ncol=1)
#
pc <- 10
```
...
saveRDS(obj.ls.qc,"/proj/user/mattia/Embryo_2/obj.ls.qc_nanoCTR_e13_K4_5kb_bins.rds")
saveRDS(combined.obj.ls,"/proj/user/mattia/Embryo_2/combined.obj.ls_epi_mod_nanoCTR_e13_K4_5kb_bins.rds")
