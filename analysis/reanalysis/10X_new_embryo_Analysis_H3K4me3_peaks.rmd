...
# H3K27ac
combined.obj.ls$H3K4me3_CCTATCCT <- RunUMAP(combined.obj.ls$H3K4me3_CCTATCCT,reduction = 'lsi', dims = 2:40)
combined.obj.ls$H3K4me3_CCTATCCT <- FindNeighbors(combined.obj.ls$H3K4me3_CCTATCCT,reduction = 'lsi', dims = 2:40)
...
```{r}
combined.obj.ls$H3K27me3_ATAGAGGC <- RunHarmony(
...
combined.obj.ls$H3K27me3_ATAGAGGC <- FindNeighbors(combined.obj.ls$H3K27me3_ATAGAGGC, reduction = "harmony_lsi", dims = 1:40,k.param = 20 ,nn.method = "annoy", n.trees = 50, annoy.metric = "euclidean",graph.name=c("harmony_nn","harmony_snn"))
combined.obj.ls$H3K27me3_ATAGAGGC <- FindClusters(combined.obj.ls$H3K27me3_ATAGAGGC, resolution = 0.5,graph.name ="harmony_snn", cluster.name="clusters_harmony_lsi")
combined.obj.ls$H3K27me3_ATAGAGGC<- RunUMAP(combined.obj.ls$H3K27me3_ATAGAGGC, reduction = "harmony_lsi",dims = 1:40,reduction.name = "UMAP_harmony_lsi")

p1<-DimPlot(combined.obj.ls$H3K27me3_ATAGAGGC, reduction = "UMAP_harmony_lsi",group.by = "clusters_harmony_lsi")
p1
```
